...
theta2=[]
#------------------------------------------------
with open('HLS_float.CSV') as csv_file:
...
ax.plot(t,theta2,'g',lw=2)                   #Theta_2 estimated
ax.plot([0,stoptime],[b, b],'k--',lw=2);
ax.grid(True)
plt.savefig("theta1_theta2_estimadas_HLS_float.png")
...
plt.savefig("theta1_theta2_phaseplane_HLS_float.png")
