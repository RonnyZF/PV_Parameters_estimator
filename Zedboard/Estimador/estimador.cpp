...
#pragma HLS dataflow
	...
	parameters_estimator<est_precision > (in_est,out,raw_out_real,raw_out,GAMMA11,GAMMA12,GAMMA21,GAMMA22,INIT_ALPHA,INIT_BETA,T_SAMPLING);
	return 0;
}
...
#pragma HLS dataflow
	fixed_estimator(seq_in_xadc,vector_out,raw_vector_out,I_scale_factor,V_scale_factor,Ig,GAMMA11,GAMMA12,GAMMA21,GAMMA22,INIT_ALPHA,INIT_BETA,T_SAMPLING);
